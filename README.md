...
ファイルのダウンロード: [リリースページ](https://github.com/GD-fandev/GodiusCrystalBuffTimer/releases/tag/v1.1.0)
...
파일 다운로드: [릴리스 페이지](https://github.com/GD-fandev/GodiusCrystalBuffTimer/releases/tag/v1.1.0)
...
Download files: [Release page](https://github.com/GD-fandev/GodiusCrystalBuffTimer/releases/tag/v1.1.0)
